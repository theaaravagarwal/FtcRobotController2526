...
public class MaybeTeleOp extends OpMode {
    ...
    public void init() {
        ...
        shooter = new ShooterSubsystem(hardwareMap, "flywheel", "idx1", "idx2", "axon");

        // TUNE HERE: Flip these between FORWARD/REVERSE until it works
        shooter.configureDirections(
            DcMotorSimple.Direction.REVERSE, // Flywheel Direction
            DcMotorSimple.Direction.REVERSE, // Indexer 1 Direction
            DcMotorSimple.Direction.FORWARD // Indexer 2 Direction
        );
    ...
    public void loop() {
        ...
        if (gamepad1.a) shooter.runIntake();
        else if (gamepad1.b) shooter.shoot();
        else shooter.stop();
